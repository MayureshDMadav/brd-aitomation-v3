...
const publishForm = async() =>{
  ...
  return (
    ...
    <AlertDialogContent>
      ...
      <AlertDialogDescription>This Action cannot be Undone, After publishing you won't be able to edit this form.</AlertDialogDescription>
      <br/><br/>
      <span className="font-medium">
        By Publishing this form you will make this form as public and you will be able to collect information for submitted form.
      </span>
      </AlertDialogHeader>
      <AlertDialogFooter>
