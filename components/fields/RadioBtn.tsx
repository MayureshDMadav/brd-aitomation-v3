...
import { FormElement, FormElementInstance, SubmitFunction } from "../FormElements";
import useDesigner from "../hooks/useDesigner";

// Define the properties schema for radio field
...
const DesignerComponent = ({
  ...
  const FormComponent = ({
    ...
    const { label, required, helperText, options } =
          ...
          <div key={index} className="flex items-center">
            <input
              ...
              onChange={(e) => {
                ...
                const valid = RadioFieldFormElement.validate(element, newValue);
                setErr(!valid);
